package com.example.mapswithmapbox

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.Toast
import androidx.appcompat.content.res.AppCompatResources
import com.example.mapswithmapbox.utils.LocationPermissionsHelper
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var locationPermissionHelper: LocationPermissionsHelper
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        locationPermissionHelper =
            LocationPermissionsHelper(WeakReference(this))
    ...
    private fun onCameraTrackingDismissed() {
        Toast.makeText(this, "onCameraTrackingDismissed",
